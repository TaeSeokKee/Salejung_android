...
public class LocationForUploadActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_location_for_upload);
        ...
        if (user != null) {
            ...
            Intent intent = new Intent(LocationForUploadActivity.this, LoginActivity.class);
            intent.putExtra("returnActivity","LocationForUploadActivity");
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mLat != LOCATION_NULL && mLng != LOCATION_NULL) {
                    ...
                    Intent intent = new Intent(LocationForUploadActivity.this, UploadActivity.class);
                    startActivity(intent);
                } else {
                    // TODO :
                }
